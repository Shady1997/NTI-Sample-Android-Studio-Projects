...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        facebookImageView = findViewById(R.id.iv_ic_facebook);
        instagramImageView = findViewById(R.id.iv_ic_insta);
        twitterImageView = findViewById(R.id.iv_ic_twitter);
        ...
        twitterImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent twitter = new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.twitter.com"));
